    ...
    var text = [
        ...
        [
            ...
            },
            {
                ...
                EN: 'My favourite Weekly Boss BGM is <color style="color:#FFD780;"><b>Vitas Corrodens Pestis</b></color> (5.3 Gosoythoth)'
            },
            {
                CH: '我最喜欢的BOSS战斗曲是<color style="color:#FFD780;">《安魂的协奏曲》</color>（魔像督军）',
                EN: 'My favourite ordinary Boss BGM is <color style="color:#FFD780;"><b>Requiem Resonantia</b></color> (4.6 Legatus Golem)'
            },
            {
                CH: '我最喜欢的地区战斗曲是<color style="color:#FFD780;">《受龙所选的试炼》</color>（远古圣山）',
                EN: 'My favourite area combat BGM is <color style="color:#FFD780;"><b>The Chosen of Dragons\' Trials</b></color> (5.5 Sacred Mountain)'
            },
            {
                CH: '星穹铁道暂时没什么特别喜欢的音乐...',
