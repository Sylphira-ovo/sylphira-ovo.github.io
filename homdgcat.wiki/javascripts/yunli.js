$(function () {
    ...
    if (!lazy) {
        if (avid == '1') {
            ...
            parts = [part_2, part_4, part_1, part_3]
        }
    } else {
        if (avid == '1') {
            parts = [part_1_, part_2, part_4, part_3]
        } else if (avid == '2') {
            parts = [part_2_, part_4, part_1, part_3]
        } else if (avid == '3') {
            parts = [part_3_, part_2, part_4, part_1]
        } else if (avid == '4') {
            parts = [part_4_, part_2, part_1, part_3]
        } else {
            parts = [part_2, part_4, part_1, part_3]
        }
    }
