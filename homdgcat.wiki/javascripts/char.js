$(function () {
    ...
    function cntd() {
        ...
        if (countdown_time == 0) {
            $('.countdown').html(countdown_ver + " " + (lang == 'CH' ? '时间未知' : 'Time unknown'))
            return
        }
        if (diff < 0) {
            $('.countdown').html(countdown_ver + " " + (lang == 'CH' ? '00:00:00' : '00:00:00'))
            return
        }
            ...
            div: [
                ...
                },
                {
                    div: [
                        ...
                        {
                            p: {
                                CH: '<a href="https://yuhengcup.wiki" target="_blank">yuhengcup.wiki</a> | <a href="https://space.bilibili.com/3537104994831140" target="_blank">b站@妮可少女</a>',
    ...
    function renderAvatarAfter_2() {
                    ...
                    div: [
                        {
                            div: [
                                ...
                                {
                                    p: (this_avatar.Desc ? this_avatar.Desc : '').replaceAll('#', '</color>').replaceAll('@', "<color style='color:#FFD780;'>"),
                                    style: {
                                        'text-align': 'center',
                                        margin: '-8px auto 8px',
                                        width: '100%',
        ...
        this_avatar.Skills.forEach(function (skill_data) {
            ...
            if (skill_data.Desc) {
                skill_data_content.push({
                    p: skill_data.Desc.replaceAll('#', '</b></color>').replaceAll('@', "<color style='color:#F29E38';><b>").replaceAll('``', "<b>").replaceAll('`', '</b>')
                })
            }
            if (skill_data.DescList) {
                skill_data.DescList.forEach(function (skill_desc) {
                    skill_data_content.push({
                        p: skill_desc.replaceAll('#', '</b></color>').replaceAll('@', "<color style='color:#F29E38';><b>").replaceAll('``', "<b>").replaceAll('`', '</b>')
                    })
                })
            }
            $('.mon_body').render({
    ...
    function param(text, params) {
        ...
        return PP.replaceAll("#", "</color>").replaceAll("@", "<color style='color:#f29e38;'>").replaceAll('<br><br>', '<p style="height:0.7em;width:100%;"> </p>')
    }
